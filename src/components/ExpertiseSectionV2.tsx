...
const ExpertiseSectionV2 = () => {
  ...
  return (
    <section id="services" className="py-20 md:py-20 py-4 bg-[#611427]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <CardHeader>
                  <CardTitle className="text-xl font-montserrat font-futura-bold text-[#641528]">
                    {service.title}
                  </CardTitle>
        ...
        <div className="md:hidden">
          ...
          {isOpen && (
            <div className="mt-4 space-y-4">
              ...
              {services.map((service, index) => (
                <div key={index} className="bg-white rounded-lg shadow-sm border border-white/20 overflow-hidden">
...
export default ExpertiseSectionV2;
